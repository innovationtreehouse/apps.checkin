...
export const PAGES: PageEntry[] = [
  ...
  { href: '/system-status/unsynced-scans', label: 'Unsynced Scans', section: 'System Status', keywords: 'kiosk parked replay badge scan review stale out of order offline queue', visible: SAFETY },
