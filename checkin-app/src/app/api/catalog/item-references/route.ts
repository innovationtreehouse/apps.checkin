...
export const GET = handler("GET /api/catalog/item-references", itemReferences.list);
export const POST = handler("POST /api/catalog/item-references", itemReferences.create);
