...
export const GET = handler("GET /api/catalog/item-references", routes.itemReferences.list);
export const POST = handler("POST /api/catalog/item-references", routes.itemReferences.create);
