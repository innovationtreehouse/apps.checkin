...
export const GET = handler("GET /api/catalog/categories", routes.categories.list);
export const POST = handler("POST /api/catalog/categories", routes.categories.create);
